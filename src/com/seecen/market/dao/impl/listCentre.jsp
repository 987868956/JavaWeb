...
<script type="text/javascript">
	...
	function checkForm() {
		...
		if ("该中心名已经存在,请重新输入" == $("#agNameTips_id").val()) {
			alert("该中心名已经存在");
			$("#agName_id").focus();
			return false;
		}
	...
	<div class="rightinfo">
		<div class="tools">
			<ul class="toolbar">
				...
				<li>中心名称<input type="text" name="CName" class="agency_input"/></li>
				<li>中心地址<input type="text" name="CAddress" class="agency_input"/></li>
				<li><input type="submit"  class="agency_input" value="查询"/></li>
				</form>
			</ul>
		</div>
