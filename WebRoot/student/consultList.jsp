	...
	$(document).ready(function() {
		...
		$("#fm").submit(function() {
			...
			if ($("#tid").val() != "") {
				...
				this.action = "consult!update?cid="+yyb;
			} else {
				this.action = "consult!add";
			}
			return true;
		});
...
<body>
	<div class="place">
		...
		<ul class="placeul">
			...
			<li><a href="#" id="subItem_id">学员面谈记录</a></li>
		</ul>
	</div>
		...
		<table class="tablelist">
			...
			<tbody>
				...
				<tr>
					...
					<td>${consult.userId.userName}</td>
					<td><fmt:formatDate value="${consult.createDate}" pattern="YYYY-MM-dd"/></td>
		...
		<div class="pagin">
			...
			<ul class="paginList">
				<li class="paginItem"><a
					href="consult?currentPage=${currentPage-1 }"><span
				...
				<form id="fm" method="post">
					<table class="addTab" cellpadding="5">
						<tr>
							...
							<td width="60" class="td_lable">谈话时间</td>
							<td><input id="ttime" name="createDate" class="scinput"
								readonly="readonly" onclick="WdatePicker()" onfocus="WdatePicker()"/></td>
						</tr>
						<tr>
							<td class="td_lable">面谈老师</td>
							...
							<td class="td_lable">面谈结果</td>
							<td><input type="text" name="content" value=""
								id="tresult" class="scinput" /></td>
						<tr>
